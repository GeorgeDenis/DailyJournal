...
public class MenuLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Logout", LogoutView.class, LineAwesomeIcon.USER.create()));
        nav.addItem(new AppNavItem("Main", MainView.class, LineAwesomeIcon.USER.create()));
        nav.addItem(new AppNavItem("Books", BooksView.class, LineAwesomeIcon.USER.create()));
