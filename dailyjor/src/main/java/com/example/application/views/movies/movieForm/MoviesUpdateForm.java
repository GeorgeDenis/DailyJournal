...
@PageTitle("Movie Update")
@Route(value = "movie-update", layout = MenuLayout.class)
@Uses(Icon.class)
public class MoviesUpdateForm extends Div {
    private IntegerField id = new IntegerField("Movie Id");
    ...
    public MoviesUpdateForm(MovieService movieService, UserService userService) {
        ...
        save.addClickListener(e -> {
            ...
            if(userLogged == null){
                ...
                ResponseEntity<String> response = movieService.updateMovie(binder.getBean());
    ...
    private Component createFormLayout() {
        ...
        formLayout.add(id,name,rating,finish);
        return formLayout;
    }
