...
@PageTitle("Fitness Update")
@Route(value = "fitness-update", layout = MenuLayout.class)
@Uses(Icon.class)
public class FitnessUpdateForm extends Div {
    private IntegerField id = new IntegerField("Fitness Id");
    ...
    public FitnessUpdateForm(FitnessService fitnessService, UserService userService) {
        ...
        save.addClickListener(e -> {
            ...
            if(userLogged == null){
                ...
                ResponseEntity<String> response = fitnessService.updateFitness(binder.getBean());

                if (response.getStatusCode() == HttpStatus.CREATED) {
                    Notification.show("Fitness entry updated successfully.");
    ...
    private Component createFormLayout() {
        ...
        formLayout.add(id,gym,water,sleep,calories);
        return formLayout;
    }
